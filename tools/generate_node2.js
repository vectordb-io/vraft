        ...
        // generate one node
        {
          ...
          /*
                    // line 5
                    {
                      if (Object.keys(json_obj[raftid][1][0]).length >= 4) {
                        ...
                        for (let i = 0; i < peers.length; i++) {
                          ...
                          {
                            var match =
             json_obj[raftid][1][0][3][peer][0]['match']; if ((event_name ==
             'state_end') && (Object.keys(begin_json_obj).length != 0) && match
             != begin_json_obj[raftid][1][0][3][peer][0]['match']) {
                          ...
                          {
                            var next =
             json_obj[raftid][1][0][3][peer][0]['next']; if ((event_name ==
             'state_end') && (Object.keys(begin_json_obj).length != 0) && next
             != begin_json_obj[raftid][1][0][3][peer][0]['next']) {
                          ...
                          {
                            var done =
             json_obj[raftid][1][0][3][peer][1]['done']; if ((event_name ==
             'state_end') && (Object.keys(begin_json_obj).length != 0) && done
             != begin_json_obj[raftid][1][0][3][peer][1]['done']) {
                          ...
                          {
                            var grant =
             json_obj[raftid][1][0][3][peer][1]['grant']; if ((event_name ==
             'state_end') && (Object.keys(begin_json_obj).length != 0) && grant
             != begin_json_obj[raftid][1][0][3][peer][1]['grant']) {
                          ...
                          {
                            var logok =
             json_obj[raftid][1][0][3][peer][1]['logok']; if ((event_name ==
             'state_end') && (Object.keys(begin_json_obj).length != 0) && logok
             != begin_json_obj[raftid][1][0][3][peer][1]['logok']) {
                          ...
                          // iok
                          {
                            ...
                            if ((event_name == 'state_end') &&
                                (Object.keys(begin_json_obj).length != 0) &&
                                iok !=
             begin_json_obj[raftid][1][0][3][peer][1]['iok']) {
                              writeStream.write(td_change_str);
                            } else {
                              writeStream.write(td_str);
                            }
